      ...
      >
        <div className="glass-panel p-8 md:p-10">
          <div className="flex flex-col items-center mb-10">
            <div className="w-16 h-16 bg-kofert-green rounded-2xl flex items-center justify-center text-white text-3xl font-bold shadow-xl shadow-kofert-green/30 mb-4">
              K
            </div>
